...
CV_CODE_PREPARE = (
    ...
    "const prompt =\n"
    "  'Es um especialista em recrutamento em Angola. Analisa o curriculo abaixo e devolve APENAS um objecto JSON valido, sem texto antes ou depois, seguindo exactamente esta estrutura:\\n\\n' +\n"
    "  '{\\n' +\n"
    "  '  \"score\": 72,\\n' +\n"
    "  '  \"skills\": [\"Gestao de projectos\", \"Excel avancado\", \"Comunicacao\"],\\n' +\n"
    ...
    "  '}\\n\\n' +\n"
    "  'Criterios para o campo score (numero inteiro de 0 a 100):\\n' +\n"
    "  '- Clareza e estrutura do CV (seccoes bem definidas, informacao facil de localizar).\\n' +\n"
    "  '- Relevancia e profundidade da experiencia profissional descrita.\\n' +\n"
    "  '- Presenca de resultados concretos ou quantificaveis (ex: aumentou vendas em 20%).\\n' +\n"
    "  '- Adequacao da formacao e competencias ao perfil descrito.\\n' +\n"
    "  'Um curriculo vazio, incompleto ou ilegivel deve ter score abaixo de 30, e o feedback deve explicar essa limitacao em vez de inventar informacao que nao existe no texto.\\n\\n' +\n"
    "  'O campo skills deve ter entre 5 e 15 competencias tecnicas e comportamentais reais mencionadas ou claramente implicitas no curriculo, sem repeticoes.\\n\\n' +\n"
    "  'Responde sempre em portugues, mesmo que o curriculo esteja noutra lingua.\\n\\n' +\n"
    "  'CURRICULO:\\n' + cvText;\n"
    "\n"
    "return [{ json: {\n"
...
SCORE_CODE_PREPARE = (
    ...
    "\n"
    "const prompt =\n"
    "  'Es um especialista em recrutamento em Angola. Analisa a correspondencia entre o candidato e a vaga abaixo.\\n\\n' +\n"
    "  'CANDIDATO:\\n' +\n"
    "  '- Competencias: ' + skills + '\\n' +\n"
    "  '- Resumo: ' + summary + '\\n' +\n"
    ...
    "  'Devolve APENAS um objecto JSON valido, sem texto antes ou depois, seguindo exactamente esta estrutura:\\n\\n' +\n"
    "  '{\\n' +\n"
    "  '  \"similarity_score\": 68,\\n' +\n"
    "  '  \"match_feedback\": \"Duas a tres frases em portugues com os pontos fortes e depois as lacunas do candidato face aos requisitos.\"\\n' +\n"
    "  '}\\n\\n' +\n"
    "  'Criterios para o campo similarity_score (numero inteiro de 0 a 100):\\n' +\n"
    "  '- Competencias tecnicas do candidato que correspondem aos requisitos da vaga (peso 40%).\\n' +\n"
    "  '- Relevancia e nivel da experiencia profissional face ao que a vaga exige (peso 35%).\\n' +\n"
    "  '- Adequacao da formacao academica, quando mencionada (peso 15%).\\n' +\n"
    "  '- Idiomas, quando relevantes para a vaga (peso 10%).\\n' +\n"
    "  'Se faltar informacao do candidato para avaliar algum criterio, considera esse criterio neutro em vez de penalizar ou beneficiar sem base.\\n\\n' +\n"
    "  'Responde sempre em portugues, mesmo que os dados estejam noutra lingua.';\n"
    "\n"
    "return [{ json: {\n"
